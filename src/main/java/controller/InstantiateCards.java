...
public abstract class InstantiateCards {
    static void start() throws IOException, CsvException {
        FileReader file = new FileReader("C:\\Users\\paitakht\\IdeaProjects\\PPP_testing_3\\src\\main\\java\\controller\\CardsInCsv\\Monster.csv");
        ...
        file.close();
        file = new FileReader("C:\\Users\\paitakht\\IdeaProjects\\PPP_testing_3\\src\\main\\java\\controller\\CardsInCsv\\Trap.csv");
        ...
        file.close();
        file = new FileReader("C:\\Users\\paitakht\\IdeaProjects\\PPP_testing_3\\src\\main\\java\\controller\\CardsInCsv\\Spell.csv");
        list = new ArrayList<>(new CSVReaderBuilder(file).withSkipLines(1).build().readAll());
        list.forEach(info -> {
