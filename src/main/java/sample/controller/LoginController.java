...
import sample.view.listener.Listener;
...
//        users = new HashMap<>();
        ...
        User user = User.createUser("a", "a", "a", "C:\\Users\\ALIREZA\\Desktop\\everything\\screenshot\\skyrim1.png", "C:\\Users\\ALIREZA\\Desktop\\everything\\screenshot\\skyrim1.png", LocalDate.now());
//        user.setImageAddress("C:\\Users\\ALIREZA\\Desktop\\everything\\screenshot\\skyrim1.png");
//        Deck deck = new Deck("a");
//        for (int i = 0; i < 20; i++) deck.addCard("Battle OX", false);
////        for (int i = 0; i < 3; i++) deck.addCard("Closed Forest", false);
////        for (int i = 0; i < 3; i++) deck.addCard("Pot of Greed", false);
////        for (int i = 0; i < 3; i++) deck.addCard("Black Pendant", false);
////        for (int i = 0; i < 3; i++) deck.addCard("Marshmallon", false);
////        for (int i = 0; i < 3; i++) deck.addCard("Negate Attack", false);
////        for (int i = 0; i < 3; i++) deck.addCard("Suijin", false);
////        for (int i = 0; i < 3; i++) deck.addCard("Trap Hole", false);
//        for (int i = 0; i < 20; i++) deck.addCard("Twin Twisters", false);
////        for (int i = 0; i < 3; i++) deck.addCard("Yomi Ship", false);
////        for (int i = 0; i < 3; i++) deck.addCard("Advanced Ritual Art", false);
////        for (int i = 0; i < 3; i++) deck.addCard("Crab Turtle", false);
////        for (int i = 0; i < 3; i++) deck.addCard("Magic Cylinder", false);
////        for (int i = 0; i < 3; i++) deck.addCard("Leotron", true);
//        user.setActiveDeck(deck);
//        User user1 = User.createUser("b", "b", "b", "C:\\Users\\ALIREZA\\Desktop\\everything\\screenshot\\skyrim1.png", "C:\\Users\\ALIREZA\\Desktop\\everything\\screenshot\\skyrim1.png", LocalDate.now());
//        user1.setImageAddress("C:\\Users\\ALIREZA\\Desktop\\everything\\screenshot\\skyrim1.png");
//        Deck deck1 = new Deck("b");
////        for (int i = 0; i < 3; i++) deck1.addCard("Battle OX", false);
////        for (int i = 0; i < 3; i++) deck1.addCard("Closed Forest", false);
////        for (int i = 0; i < 3; i++) deck1.addCard("Pot of Greed", false);
////        for (int i = 0; i < 3; i++) deck1.addCard("Black Pendant", false);
////        for (int i = 0; i < 3; i++) deck1.addCard("Marshmallon", false);
////        for (int i = 0; i < 3; i++) deck1.addCard("Negate Attack", false);
////        for (int i = 0; i < 3; i++) deck1.addCard("Suijin", false);
////        for (int i = 0; i < 3; i++) deck1.addCard("Trap Hole", false);
////        for (int i = 0; i < 3; i++) deck1.addCard("Twin Twisters", false);
////        for (int i = 0; i < 3; i++) deck1.addCard("Yomi Ship", false);
////        for (int i = 0; i < 3; i++) deck1.addCard("Advanced Ritual Art", false);
////        for (int i = 0; i < 3; i++) deck1.addCard("Crab Turtle", false);
//        for (int i = 0; i < 20; i++) deck1.addCard("Magic Cylinder", false);
////        for (int i = 0; i < 3; i++) deck1.addCard("Leotron", true);
...
//    }
    ...
    public String createUser(String username, String password, String nickname, LocalDate dateOfBirth2) {
