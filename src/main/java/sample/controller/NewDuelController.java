...
public class NewDuelController implements RegexPatterns, StringMessages {
    ...
    public static String newDuel(String rounds, String opponentUsername){
        return SENDER.getResponse(SENDER.setMessageWithoutToken(PREFIX, "run", rounds, opponentUsername));
    }
