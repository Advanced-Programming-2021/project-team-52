...
//        }).start();
    ...
    public void setUsersInBoard() {
        ...
        if (size > 0) {
            ...
            setOnlineUsersStyle(player01, player01Score,onlineUsers);
        }
        if (size > 1) {
        ...
        if (size > 2) {
            ...
            setOnlineUsersStyle(player03, player03Score,onlineUsers);
        }
        if (size > 3) {
            ...
            setOnlineUsersStyle(player04, player04Score,onlineUsers);
        }
        if (size > 4) {
